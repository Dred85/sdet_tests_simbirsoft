...
Python (рекомендуется использовать версию 3.10) создать проект UI-
...
2Кейс. Заполнение формы регистрации
Предусловие:
1. Открыть браузер
...
3Кейс. Заполнение формы регистрации
...
Для выполнения тестового задания я использовал ЯП Python версии 3.10, pytest и selenium. Создан файл с зависимостями 
requirements.txt
Для запуска тестов необходимо в терминале набрать pytest
Для формирования отчета необходимо в терминале набрать pytest --alluredir=allure-results
